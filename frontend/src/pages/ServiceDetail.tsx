                ...
                <aside className="sidebar">
                    <div className="sidebar-sticky">
                        ...
                        <div className="cta-card">
                            ...
                            <p>Book your {serviceCategory.category} service online and pay securely.</p>
                            <Link to={`/booking?service=${serviceCategory.slug}`} className="cta-btn">Book This Service</Link>
                        </div>
                    </div>
                </aside>
            </div>
